...
\begingroup
  ...
  \begin{picture}(7200.00,5040.00)%
    \gplgaddtomacro\gplbacktext{%
      ...
      \put(176,2739){\rotatebox{-270}{\makebox(0,0){\strut{}$\frac {\phi} {\phi_0}$}}}%
      \put(3940,154){\makebox(0,0){\strut{}$\omega_e t$}}%
      \put(2509,3248){\makebox(0,0)[l]{\strut{}$\sim \cos(\omega t)$}}%
      \put(1794,3961){\makebox(0,0)[l]{\strut{}$\sim e^{- \beta t}$}}%
    }%
    \gplgaddtomacro\gplfronttext{%
    }%
    \gplbacktext
    \put(0,0){\includegraphics{frei}}%
    \gplfronttext
  \end{picture}%
\endgroup
